---
name: "source-command-review-pr-comments"
description: "Run the migrated source command `review-pr-comments`."
---

# source-command-review-pr-comments

Use this skill when the user asks to run the migrated source command `review-pr-comments`.
...
Migrated from source command `review-pr-comments` into a Codex skill. Invoke it as `$source-command-review-pr-comments` and manually rewrite any slash-command behavior that depended on provider-specific runtime expansion.
