---
name: "source-command-review-pull-request"
description: "Run the migrated source command `review-pull-request`."
---

# source-command-review-pull-request

Use this skill when the user asks to run the migrated source command `review-pull-request`.
...
Migrated from source command `review-pull-request` into a Codex skill. Invoke it as `$source-command-review-pull-request` and manually rewrite any slash-command behavior that depended on provider-specific runtime expansion.
