...
import { lumiereFieryFriend } from "./121-lumiere-fiery-friend";

const allyCharacter = createMockCharacter({
  id: "lumiere-fiery-friend-009-ally",
  name: "Ally Character",
  cost: 2,
  strength: 2,
  willpower: 3,
...
const wardCharacter = createMockCharacter({
  id: "lumiere-fiery-friend-009-ward-ally",
  name: "Ward Character",
  cost: 3,
  strength: 3,
  willpower: 4,
...
describe("Lumiere - Fiery Friend (Set 9)", () => {
