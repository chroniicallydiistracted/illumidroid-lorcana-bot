...
import { robinHoodCapableFighter } from "./193-robin-hood-capable-fighter";

const targetCharacter = createMockCharacter({
  id: "robin-hood-target",
...
describe("Robin Hood - Capable Fighter", () => {
  describe("SKIRMISH - {E} - Deal 1 damage to chosen character.", () => {
    ...
    it("deals 1 damage to chosen own character", () => {
      const testEngine = LorcanaMultiplayerTestEngine.createWithFixture(
        {
          play: [robinHoodCapableFighter, targetCharacter],
          deck: 2,
        },
        {
          deck: 2,
    ...
    it("cannot be activated when exerted", () => {
      const testEngine = LorcanaMultiplayerTestEngine.createWithFixture(
        {
          play: [{ card: robinHoodCapableFighter, exerted: true }],
          deck: 2,
        },
        {
          play: [targetCharacter],
